...
st.markdown("""
    ...
    <h2 style='color: black;'> 🌟 Select a disaster type and enter the relevant details to get an estimate of the property damage.</h2>
    <h2 style='color: black;'>📊 Simply input the attributes of the selected disaster below and click the button to predict</h2>
